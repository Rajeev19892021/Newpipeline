pipeline
{
    ...
    stages
    {
        ...
        {
            steps{
                deploy adapters: [tomcat9(alternativeDeploymentContext: '', credentialsId: '44f72dfe-6b86-4dfb-942a-545188a53217', path: '', url: 'http://172.31.15.51:8080')], contextPath: 'test22', war: '**/*.war'
            }
        }
